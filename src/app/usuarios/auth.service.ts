...
export class AuthService {
  ...
  login(usuario:Usuario):Observable<any> {
    ...
    const credenciales = btoa('angularApp' + ':' + 'angularAppPassword');
  ...
  guardarUsuario(accessToken:string):void {
    ...
    this._usuario.listaDeCarreras = payload.listaDeCarreras;
    this._usuario.dni = payload.dni;
    this._usuario.listaDeUnidadesAcademicas = payload.listaDeUnidadesAcademicas;
